...
const resultPanelStyle = `box-sizing:border-box;width:392px;height:312px;max-width:100%;padding:24px;background:#ffffff;border:1px solid ${PALETTE.uiText};text-align:center;`;
